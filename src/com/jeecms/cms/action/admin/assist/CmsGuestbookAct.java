...
public class CmsGuestbookAct {
	...
	public String save(CmsGuestbook bean, CmsGuestbookExt ext, Integer ctgId,
		...
		String Realname = ext.getContent();
		Realname = StringUtils.replaceEach(Realname, new String[]{"\'","<",">"}, new String[]{"","",""});
		ext.setContent(Realname);
		Realname = ext.getEmail();
		Realname = StringUtils.replaceEach(Realname, new String[]{"\'","<",">"}, new String[]{"","",""});
		ext.setEmail(Realname);
		Realname = ext.getPhone();
		Realname = StringUtils.replaceEach(Realname, new String[]{"\'","<",">"}, new String[]{"","",""});
		ext.setPhone(Realname);
		Realname = ext.getQq();
		Realname = StringUtils.replaceEach(Realname, new String[]{"\'","<",">"}, new String[]{"","",""});
		ext.setQq(Realname);
		Realname = ext.getReply();
		Realname = StringUtils.replaceEach(Realname, new String[]{"\'","<",">"}, new String[]{"","",""});
		ext.setReply(Realname);
