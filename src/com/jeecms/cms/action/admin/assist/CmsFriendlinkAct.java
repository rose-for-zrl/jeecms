...
public class CmsFriendlinkAct {
	...
	public String save(CmsFriendlink bean, Integer ctgId,
		...
		Realname = bean.getDescription();
		Realname = StringUtils.replaceEach(Realname, new String[]{"\'","<",">"}, new String[]{"","",""});
		bean.setDescription(Realname);
		Realname = bean.getEmail();
		Realname = StringUtils.replaceEach(Realname, new String[]{"\'","<",">"}, new String[]{"","",""});
		bean.setEmail(Realname);
		Realname = bean.getDomain();
		Realname = StringUtils.replaceEach(Realname, new String[]{"\'","<",">"}, new String[]{"","",""});
		bean.setDomain(Realname);
		Realname = bean.getLogo();
		Realname = StringUtils.replaceEach(Realname, new String[]{"\'","<",">"}, new String[]{"","",""});
		bean.setLogo(Realname);
