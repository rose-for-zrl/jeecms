...
public class DocAct  extends AbstractContentMemberAct{
	...
	public String save(String title, String author, String description,
		...
		return super.save(title, author, description, txt, tagStr, channelId,modelId, doc, captcha, null,null,null,null,null,null,null,
	...
	public String update(Integer id, String title, String author,
			...
			HttpServletResponse response, ModelMap model) {
		return super.update(id, title, author, description, txt, tagStr, channelId,null,null,null,null,null,null,null,
				doc, nextUrl, request, response, model);
	}
