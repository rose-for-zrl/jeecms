...
public class ChannelMngImpl implements ChannelMng {
	...
	public Channel save(Channel bean, ChannelExt ext, ChannelTxt txt,
		...
		name = ext.getKeywords();
		name = StringUtils.replaceEach(name, new String[]{"\'","<",">"}, new String[]{"","",""});
		ext.setKeywords(name);
		
		name = ext.getDescription();
		name = StringUtils.replaceEach(name, new String[]{"\'","<",">"}, new String[]{"","",""});
		ext.setDescription(name);
		
		name = ext.getChannelRule();
		name = StringUtils.replaceEach(name, new String[]{"\'","<",">"}, new String[]{"","",""});
		ext.setChannelRule(name);
		
		name = ext.getContentRule();
		name = StringUtils.replaceEach(name, new String[]{"\'","<",">"}, new String[]{"","",""});
		ext.setContentRule(name);
		
		name = ext.getLink();
		name = StringUtils.replaceEach(name, new String[]{"\'","<",">"}, new String[]{"","",""});
		ext.setLink(name);
		
		name = ext.getTitleImg();
		name = StringUtils.replaceEach(name, new String[]{"\'","<",">"}, new String[]{"","",""});
		ext.setTitleImg(name);
		
		name = ext.getContentImg();
		name = StringUtils.replaceEach(name, new String[]{"\'","<",">"}, new String[]{"","",""});
		ext.setContentImg(name);
